...
/**
 * Classe responsável por gerar DocBlocks PHPDoc válidos utilizando a API do GPT.
 */
final class ClienteGPT {
    
    /**
     * Gera um DocBlock PHPDoc a partir de uma solicitação para a API GPT.
     * 
     * @param string $sBase A URL base da API.
     * @param string $sApiKey A chave de autenticação da API.
     * @param string $sModelo O modelo a ser utilizado na API.
     * @param string $sPrompt O prompt a ser enviado para a API.
     * @return ?string Retorna o DocBlock gerado ou null em caso de erro.
     */
